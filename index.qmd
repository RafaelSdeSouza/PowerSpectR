...
In this example pair, the spiral image produces a steeper fitted slope
(`beta ≈ -4.15`), consistent with stronger filamentary structure across a range
of scales.
:::

::: {.comparison-card}
### Elliptical Example: M60
...
The elliptical example is smoother and more centrally concentrated, with a
flatter fitted slope (`beta ≈ -2.41`) in this specific crop.
:::
:::
